...
var _=require('@stdlib/blas-base-dcabs1/dist'),b=require('@stdlib/math-base-ops-cmul/dist'),E=require('@stdlib/complex-float64-base-add/dist');function O(e,r,u,i,v,a,s,n){var q,t,o;if(e<=0||_(r)===0)return a;for(q=v,t=n,o=0;o<e;o++)a.set(E(b(r,u.get(q)),a.get(t)),t),q+=i,t+=s;return a}f.exports=O
